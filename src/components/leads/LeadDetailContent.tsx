...
const LeadDetailContent: React.FC<LeadDetailContentProps> = ({ leadId, onClose, onUpdate }) => {
    ...
    const canUpdate = (isOwner && (lead.status === 'LOCKED' || lead.status === 'PENDING')) || isAdmin;
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 2 }}>
                    ...
                    <Box>
                        ...
                        <Chip
                            label={lead.stage}
                            size="small"
                            sx={{ ml: 1, bgcolor: getStageColor(lead.stage), color: 'white' }}
                        />
                    </Box>
                    {lead.lockedUntil && (
                        <>
                                                ...
                                                primary={
                                                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                                        <Chip
                                                            label={update.status}
                                                            size="small"
                                                            sx={{ bgcolor: getStageColor(update.status), color: 'white' }}
                                                        />
